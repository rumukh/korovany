...
`GameEngine.getVisualPolicy()`, when provided by GFX-06, is included without
inventing a second quality policy. Actual rendering/buffer dimensions and pass
submissions remain authoritative, regardless of requested quality.
