...
const TRIPPING_VIEW: Record<HintId, (base: GameView) => GameView> = {
  ...
  rumours: (base) => ({
    ...
    rumours: [
      {
        id: 'rumour:escort:caravan-1',
        kind: 'escort',
        title: 'Корован без охраны',
        task: 'Идти рядом с корованом.',
        stake: 'Не пойдёшь — ляжет по дороге.',
        regionLabel: 'B2',
        timeRemaining: 96,
        pinned: false,
        progress: 0,
    ...
    contracts: [
      {
        ...
        contract: null,
        title: 'Осмотреть точку «Лавка»',
        task: 'Осмотреть точку «Лавка»',
      ...
      {
        id: 'objective-elf-contract',
        contract: 'unshackle',
        title: 'Свои в верёвках',
        task: 'Дойти и снять верёвки.',
