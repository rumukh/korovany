...
export const BOON_CATALOGUE = [
  {
    id: 'provisions',
    name: 'Заначка в котомке',
    description: 'Стартуете с одним дорожным пайком — на чёрный день.',
    unlockCost: 0,
  ...
  },
  {
    ...
    description: 'Соседние регионы у лагеря открыты сразу — разведка не зря пила.',
    unlockCost: 0,
    defaultUnlocked: true,
  ...
  {
    id: 'sturdy-gear',
    name: 'Броня с чужого плеча',
    description: 'Немного лишнего здоровья на старте. Прошлый владелец не жаловался.',
    unlockCost: 0,
    defaultUnlocked: true,
  ...
  },
  {
    id: 'trail-rations',
    name: 'Сухпаёк',
    description: 'Чуток лишней выносливости на старте — бегать от погони.',
    unlockCost: 45,
  ...
  },
  {
    id: 'merchant-seal',
    name: 'Ксива купца',
    description: 'Стартовый кошель монет — хватит на первую движуху у барыги.',
    unlockCost: 70,
    defaultUnlocked: false,
  ...
  },
  {
    ...
    description: 'Оружие с утра наточено — бьёт чуть злее.',
    unlockCost: 95,
    defaultUnlocked: false,
