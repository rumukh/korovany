...
export const BOON_CATALOGUE = [
  {
    id: 'provisions',
    name: 'Припасы',
    description: 'Начните забег с одним дорожным пайком.',
    unlockCost: 0,
  ...
  },
  {
    ...
    description: 'Сразу откройте регионы рядом со стартовым лагерем.',
    unlockCost: 0,
    defaultUnlocked: true,
  ...
  },
  {
    ...
    description: 'Получите небольшой запас дополнительного здоровья.',
    unlockCost: 0,
    defaultUnlocked: true,
  ...
  },
  {
    ...
    description: 'Получите небольшой запас дополнительной выносливости.',
    unlockCost: 45,
  ...
  },
  {
    id: 'merchant-seal',
    name: 'Печать купца',
    description: 'Начните с кошельком для ранней покупки в лавке.',
    unlockCost: 70,
    defaultUnlocked: false,
  ...
  },
  {
    ...
    description: 'Начните забег с немного усиленным оружием.',
    unlockCost: 95,
    defaultUnlocked: false,
